        ...
        <div className="py-12 md:py-20">
          ...
          <div className="mx-auto max-w-3xl pb-16 text-center md:pb-20">
            <h2 className="text-3xl font-bold text-gray-200 md:text-4xl">
              Automatizações inteligentes para empresas que querem crescer sem complicação.
            </h2>
          </div>
          {/* Planet */}
          ...
          <div className="grid overflow-hidden sm:grid-cols-2 lg:grid-cols-3 *:relative *:p-6 *:before:absolute *:before:bg-gray-800 *:before:[block-size:100vh] *:before:[inline-size:1px] *:before:[inset-block-start:0] *:before:[inset-inline-start:-1px] *:after:absolute *:after:bg-gray-800 *:after:[block-size:1px] *:after:[inline-size:100vw] *:after:[inset-block-start:-1px] *:after:[inset-inline-start:0] md:*:p-10">
            <article>
              ...
              <p className="text-[15px] text-gray-400">
                O agente responde dúvidas, orienta clientes e resolve pedidos de forma imediata — mesmo fora do horário comercial.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
              ...
              <p className="text-[15px] text-gray-400">
                Gerencia horários, confirma reservas e envia lembretes sem precisar de intervenção humana.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>Captação e Qualificação de Leads</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                Identifica oportunidades, classifica interesses e envia apenas os contatos realmente valiosos para você.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>Assistente Financeiro Integrado</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                Analisa dados, cria projeções simples e oferece recomendações inteligentes para ajudar o cliente a tomar decisões melhores.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>Agente Pessoal de Negócios 24/7</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                Assistente inteligente totalmente personalizado que entende o seu modelo de trabalho.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>Criação Automática de Conteúdo</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                O agente gera posts, legendas, ideias e roteiros personalizados com base no seu estilo e no que está em alta.
              </p>
            </article>
          </div>
        </div>
